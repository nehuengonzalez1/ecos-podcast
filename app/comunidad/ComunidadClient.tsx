...
/**
 * 'abierta' decide si se muestra la suscripcion de verdad o su version
 * cerrada. La decision se toma en el servidor, en page.tsx.
 *
 * El precio llega por prop y ya no se lee aca de NEXT_PUBLIC: una variable
 * NEXT_PUBLIC queda incrustada en el javascript que baja el navegador, asi
 * que leerla desde el cliente la publicaba igual aunque en pantalla dijera
 * un guion. Leida solo en el servidor, cuando esta cerrada no viaja.
 */
            ...
            <div>
              {avisoSoloVos && (
                              <div className="mb-6 inline-flex w-fit items-center gap-2 rounded-sm border border-gold/40 bg-gold/5 px-3 py-2 text-xs text-cream-200/90">
                                ...
                                Esto lo ves solo vos. Para el resto, la suscripcion dice «proximamente».
                              </div>
                            )}
              ...
              <p className="body-copy mt-6 max-w-lg text-lg leading-relaxed text-cream-200/85">
                Por {precioTexto} al mes accedés al detrás de escena de cada
